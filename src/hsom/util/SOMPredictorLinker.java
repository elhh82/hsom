...
public class SOMPredictorLinker extends SOMInput implements Serializable{
	
    private SOMPredictor[] sourceSOM;
    private SOMPredictor higherSOM;
    ...
    /**
      ...
      */	
    public SOMPredictorLinker(SOMPredictor lowerA){
        super();
        sourceSOM = new SOMPredictor[1];
        sourceSOM[0] = lowerA;
    ...
    /**
      ...
      */
    public SOMPredictorLinker(SOMPredictor lowerA, SOMPredictor lowerB){
        super();
        sourceSOM = new SOMPredictor[2];
        sourceSOM[0] = lowerA;
        sourceSOM[1] = lowerB;
    }
     ...
     */
    public void setHigherSOM(SOMPredictor higher){
        higherSOM = higher;        
    }
